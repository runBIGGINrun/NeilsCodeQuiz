...
let startingButton = document.getElementById("start-button");
let answerRightWrong = document.getElementById("right-wrong-display");
...
let finalScore = 0;
let highScoresArray = [];
let highscoreInput = document.getElementById("highscore-list");
let highscoreOL = document.getElementById("highscore-ul");
let highscoreUlView = document.getElementById("highscore-ul-view");
